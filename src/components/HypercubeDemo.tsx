...
import { HypercubeMasterBuffer, HypercubeGrid, HeatmapEngine, CanvasAdapter } from 'hypercube-compute';

const MAP_SIZE = 400;

export const HypercubeV2Demo: React.FC = () => {
    ...
    useEffect(() => {
        ...
        // 1. Initialisation SDK V3 
        const master = new HypercubeMasterBuffer();

        // 2. Création d'un Cube 1x1 avec l'Engine Convolution Heatmap (Rayon 30)
        const grid = new HypercubeGrid(1, 1, MAP_SIZE, master, () => new HeatmapEngine(30));
        const myCube = grid.cubes[0][0]!;
    ...
    return (
        <div className="w-full h-screen bg-neutral-900 text-white flex flex-col items-center justify-center p-4">
            <h1 className="text-3xl font-bold text-amber-500 mb-2">Hypercube.js V2 - SDK Demo</h1>
